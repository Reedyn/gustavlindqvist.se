...
Min första sådan runda är i _Trelleborg_{title="Min födelsehemort"} på exakt exakt 5 kilometer. Den går bara fram och tillbaka längs med stranden mellan Åhus och Gislövs läge. Mestadels på sandiga stigar och gräs.
...
Denna rundan var min vanligaste när jag bodde på Rosenlund, den är 5,3km lång och gav fantastisk utsikt över Vättern, dock var den kanske lite för kylig på vinterhalvåret.
...
Eftersom Vattenledningsparken ligger en bit bort blev denna rundan något längre än min tidigare standarddistans på 5km, denna är på 7,2km.
...
Då blev Dunkehallaravinen med alla trapporna och Stadsparken den perfekta rundan på 5,9km.
